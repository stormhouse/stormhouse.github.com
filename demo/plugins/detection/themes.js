...
(function(de){
  ...
  classic.create = function(locale) {
    if (locale == null) {
      locale = de.getDefaultLocale();
    }

    var f = classic.implementations[locale];
    if (f == null) {
      f = classic._Impl;
    }
    return new f();
  ...
  classic._Impl = function() {
    ...
    this.event = {
      ...
      instant: {
        icon: de.urlPrefix + "images/dull-blue-circle.png",
