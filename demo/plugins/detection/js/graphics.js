...
(function(storm){
   ...
   * @type Boolean
   */
  graphics.pngIsTranslucent = (!storm.Platform.browser.isIE) || (storm.Platform.browser.majorVersion > 6);
//  if (!graphics.pngIsTranslucent) {
//    storm.includeCssFile(document, storm.urlPrefix + "styles/graphics-ie6.css");
//  }
