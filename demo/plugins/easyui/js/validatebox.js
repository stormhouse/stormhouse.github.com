...
(function($){
	...
	function bindEvents(target){
		...
		var time = null;
		box.unbind('.eui-validatebox').bind('focus.eui-validatebox', function(){
			if (time){
				clearInterval(time);
			}
		...
		}).bind('blur.eui-validatebox', function(){
			clearInterval(time);
			time = null;
			hideTip(target);
		}).bind('mouseover.eui-validatebox', function(){
			if (box.hasClass('validatebox-invalid')){
				showTip(target);
			}
		}).bind('mouseout.eui-validatebox', function(){
			hideTip(target);
		});
	}
	...
	function showTip(target){
		...
		tip.find('.eui-validatebox-tip-content').html(msg);
		tip.css({
			display:'block',
