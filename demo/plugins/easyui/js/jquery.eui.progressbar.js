...
(function($){
  function init(target){
    $(target).addClass('eui-progressbar');
    $(target).html('<div class="eui-progressbar-text"></div><div class="eui-progressbar-value"><div class="eui-progressbar-text">&nbsp;</div></div>');
    return $(target);
  }
  ...
  function setSize(target,width){
    ...
    bar._outerHeight(opts.height);
    bar.find('div.eui-progressbar-text').width(bar.width());
    bar.find('div.eui-progressbar-text').height(bar.height());
    bar.find('div.eui-progressbar-value').height(bar.height());
  }
  ...
  $.fn.progressbar.methods = {
    ...
    setValue: function(jq, value){
      ...
      return jq.each(function(){
        ...
        opts.value = value;
        $(this).find('div.eui-progressbar-value').width(value+'%');
        $(this).find('div.eui-progressbar-text').html(text);
        if (oldValue != value){
