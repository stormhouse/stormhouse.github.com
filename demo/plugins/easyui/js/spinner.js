...
(function($){
	...
	function init(target){
		var spinner = $(
				'<span class="eui-spinner">' +
				'<span class="eui-spinner-arrow" unselectable="on" style="-moz-user-select:none;" onselectstart="return false;">' +
				'<span class="eui-spinner-arrow-up"></span>' +
				'<span class="eui-spinner-arrow-down"></span>' +
				'</span>' +
				'</span>'
				).insertAfter(target);
		$(target).addClass('eui-spinner-text').prependTo(spinner);
		return spinner;
	}
	...
	function setSize(target, width){
		...
		var arrowWidth = spinner.find('.eui-spinner-arrow').outerWidth();
	...
	function bindEvents(target){
		...
		spinner.find('.eui-spinner-arrow-up,.eui-spinner-arrow-down').unbind('.eui-spinner');
		if (!opts.disabled){
			spinner.find('.eui-spinner-arrow-up').bind('mouseenter.eui-spinner', function(){
				$(this).addClass('eui-spinner-arrow-hover');
			}).bind('mouseleave.eui-spinner', function(){
				$(this).removeClass('eui-spinner-arrow-hover');
			}).bind('click.eui-spinner', function(){
				opts.spin.call(target, false);
				opts.onSpinUp.call(target);
				$(target).validatebox('validate');
			});
			
			spinner.find('.eui-spinner-arrow-down').bind('mouseenter.eui-spinner', function(){
				$(this).addClass('eui-spinner-arrow-hover');
			}).bind('mouseleave.eui-spinner', function(){
				$(this).removeClass('eui-spinner-arrow-hover');
			}).bind('click.eui-spinner', function(){
